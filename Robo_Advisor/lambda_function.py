...
def validate_data(age, investment_amount, intent_request):
    """
    Validates the data (age and investment amount) provided by the user.
    """
    ...
    if age is not None:
        ...
        if (age > 65) or (age < 0):
            return build_validation_result(
                False,
                "age",
                "There is a required age between 0 and 65 years old to use this service. "
                "Please make sure your age is correct.",
            )
    ...
    if investment_amount is not None:
        ...
        if investment_amount < 5000:
            return build_validation_result(
                False,
                "investmentAmount",
                "The minimun amount to invest is $5,000.00 USD. "
